...
{
    /// <summary>
    /// TOP API: dingtalk.oapi.rhino.mos.exec.clothes.get
    /// </summary>
    public class OapiRhinoMosExecClothesGetRequest : BaseDingTalkRequest<DingTalk.Api.Response.OapiRhinoMosExecClothesGetResponse>
    {
        /// <summary>
        /// 衣服ID列表
        /// </summary>
